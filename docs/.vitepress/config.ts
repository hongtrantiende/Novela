...
export default defineConfig({
  ...
  base: '/Novela/',
  head: [
    ['link', { rel: 'icon', href: '/Novela/favicon.ico' }]
  ],
  themeConfig: {
    logo: '/logo.png',
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/hongtrantiende/Novela' },
    ],
    footer: {
    ...
    editLink: {
      pattern: 'https://github.com/hongtrantiende/Novela/edit/main/docs/:path',
