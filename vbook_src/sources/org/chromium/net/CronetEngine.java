...
public abstract class CronetEngine {
    ...
    public static class Builder {
        ...
        private final List<fc2> mExperimentalOptionsPatches;
            ...
            if (str != null && str2 != null) {
                ...
                for (int i = 0; i < split.length && i < split2.length; i++) {
                    try {
                        ...
                        throw new IllegalArgumentException(eub.p("Unable to convert version segments into integers: ", split[i], " & ", split2[i]), e);
                    }
                }
                return Integer.signum(split.length - split2.length);
            }
            vs.m("The input values cannot be null");
            return 0;
        }

        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r4v3, types: [java.lang.Object, kc2] */
        private static ICronetEngineBuilder createBuilderDelegate(Context context) {
            s0a.o("CronetEngine#createBuilderDelegate");
            try {
                long uptimeMillis = SystemClock.uptimeMillis();
                qc2 qc2Var = getEnabledCronetProviders(context, new ArrayList(CronetProvider.getAllProviderInfos(context))).get(0);
                oc2 d = nc2.d(context, qc2Var.b);
                ?? obj = new Object();
                obj.c = -1;
                obj.e = Boolean.FALSE;
                obj.b = 1;
                obj.d = qc2Var.b;
                obj.h = Process.myUid();
                obj.f = new mc2(ApiVersion.getCronetVersion());
                if (Log.isLoggable(TAG, 3)) {
                    Log.d(TAG, String.format("Using '%s' provider for creating CronetEngine.Builder.", qc2Var.a));
                }
                ICronetEngineBuilder iCronetEngineBuilder = qc2Var.a.createBuilder().mBuilderDelegate;
                String implCronetVersion = getImplCronetVersion(iCronetEngineBuilder);
                if (implCronetVersion != null) {
                    obj.g = new mc2(implCronetVersion);
                }
        ...
        public static List<qc2> getEnabledCronetProviders(Context context, List<qc2> list) {
            if (!list.isEmpty()) {
                ...
                cy7.e("All available Cronet providers are disabled. A provider should be enabled before it can be used.");
                return null;
            }
            cy7.e("Unable to find any Cronet provider. Have you included all necessary jars?");
            return null;
        }
        ...
        private static int getImplApiLevel(ICronetEngineBuilder iCronetEngineBuilder) {
            try {
                ...
                cp8.p("Failed to retrieve Cronet impl API level", e);
                return 0;
            }
        }
        ...
        private static String getImplCronetVersion(ICronetEngineBuilder iCronetEngineBuilder) {
            try {
                ...
                cp8.p("Failed to retrieve Cronet impl version", e);
                return null;
            }
        }
            ...
            if (connectionMigrationOptions.getEnablePathDegradationMigration() != null) {
                ...
                if (connectionMigrationOptions.getAllowNonDefaultNetworkUsage() != null) {
                    ...
                    if (!booleanValue && booleanValue2) {
                        vs.m("Unable to turn on non-default network usage without path degradation migration!");
        ...
        private void maybeSetExperimentalOptions() {
            ...
            List<fc2> list = this.mExperimentalOptionsPatches;
            if (jSONObject == null && list.isEmpty()) {
                ...
                for (fc2 fc2Var : list) {
                    try {
                        switch (fc2Var.a) {
                            case 0:
                                lambda$setQuicOptions$0((QuicOptions) fc2Var.b, jSONObject);
                                break;
                            case 1:
                                lambda$setConnectionMigrationOptions$2((ConnectionMigrationOptions) fc2Var.b, jSONObject);
                                break;
                            default:
                                lambda$setDnsOptions$1((DnsOptions) fc2Var.b, jSONObject);
                                break;
                        }
        ...
        public Builder setConnectionMigrationOptions(ConnectionMigrationOptions connectionMigrationOptions) {
            ...
            this.mExperimentalOptionsPatches.add(new fc2(connectionMigrationOptions, 1));
            return this;
        }
        ...
        public Builder setDnsOptions(DnsOptions dnsOptions) {
            ...
            this.mExperimentalOptionsPatches.add(new fc2(dnsOptions, 2));
            return this;
        }
        ...
        public Builder setProxyOptions(ProxyOptions proxyOptions) {
            ...
            xk5.q("This Cronet implementation does not support ProxyOptions");
            return null;
        }
        ...
        public Builder setQuicOptions(QuicOptions quicOptions) {
            ...
            this.mExperimentalOptionsPatches.add(new fc2(quicOptions, 0));
            return this;
        }
