...
public abstract class AstNode extends Node implements Comparable<AstNode> {
    ...
    static {
        ...
        INDENTATIONS = strArr;
        a82.v(57, hashMap, "in", 32, "typeof");
        a82.v(58, hashMap, "instanceof", 31, "delete");
        a82.v(98, hashMap, ",", Token.COLON, ":");
        a82.v(Token.OR, hashMap, "||", 185, "??");
        a82.v(Token.QUESTION_DOT, hashMap, "?.", Token.AND, "&&");
        a82.v(Token.INC, hashMap, "++", 120, "--");
        a82.v(9, hashMap, "|", 10, "^");
        a82.v(11, hashMap, "&", 12, "==");
        a82.v(13, hashMap, "!=", 14, "<");
        a82.v(16, hashMap, ">", 15, "<=");
        ...
        a82.v(28, hashMap, "+", 29, "-");
        a82.v(51, hashMap, "===", 52, "!==");
        a82.v(99, hashMap, "=", 100, "|=");
        a82.v(101, hashMap, "||=", Token.ASSIGN_BITAND, "&=");
        a82.v(Token.ASSIGN_LOGICAL_AND, hashMap, "&&=", Token.ASSIGN_LSH, "<<=");
        a82.v(Token.ASSIGN_RSH, hashMap, ">>=", Token.ASSIGN_URSH, ">>>=");
        a82.v(Token.ASSIGN_ADD, hashMap, "+=", Token.ASSIGN_SUB, "-=");
        a82.v(110, hashMap, "*=", Token.ASSIGN_DIV, "/=");
        a82.v(Token.ASSIGN_MOD, hashMap, "%=", 102, "^=");
        a82.v(Token.ASSIGN_EXP, hashMap, "**=", 114, "??=");
