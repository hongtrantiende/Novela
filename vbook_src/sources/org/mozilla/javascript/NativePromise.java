...
public class NativePromise extends ScriptableObject {
    ...
    public static void init(Context context, Scriptable scriptable, boolean z) {
        LambdaConstructor lambdaConstructor = new LambdaConstructor(scriptable, "Promise", 1, 2, new zx7(7));
        lambdaConstructor.setPrototypePropertyAttributes(7);
        lambdaConstructor.defineConstructorMethod(scriptable, "resolve", 1, new ay7(22), 2, 3);
        lambdaConstructor.defineConstructorMethod(scriptable, "reject", 1, new ay7(23), 2, 3);
        lambdaConstructor.defineConstructorMethod(scriptable, "all", 1, new ay7(24), 2, 3);
        lambdaConstructor.defineConstructorMethod(scriptable, "allSettled", 1, new ay7(25), 2, 3);
        lambdaConstructor.defineConstructorMethod(scriptable, "race", 1, new ay7(26), 2, 3);
        lambdaConstructor.defineConstructorMethod(scriptable, "any", 1, new ay7(27), 2, 3);
        ScriptRuntimeES6.addSymbolSpecies(context, scriptable, lambdaConstructor);
        lambdaConstructor.definePrototypeMethod(scriptable, "then", 2, new by7(lambdaConstructor, 1), 2, 3);
        lambdaConstructor.definePrototypeMethod(scriptable, "catch", 1, new ay7(21), 2, 3);
        lambdaConstructor.definePrototypeMethod(scriptable, "finally", 1, new by7(lambdaConstructor, 2), 2, 3);
    ...
    private static Callable makeCatchFinally(Scriptable scriptable, Object obj, Callable callable) {
        return new LambdaFunction(scriptable, 1, new ky7(scriptable, callable, obj, 1));
    }

    private static Callable makeThenFinally(Scriptable scriptable, Object obj, Callable callable) {
        return new LambdaFunction(scriptable, 1, new ky7(scriptable, callable, obj, 0));
    }
