...
public class Context implements Closeable {
    ...
    public static <T> T call(ContextFactory contextFactory, ContextAction<T> contextAction) {
        Context enter = enter(null, contextFactory);
        try {
            T run = contextAction.run(enter);
            if (enter != null) {
                enter.close();
            }
            return run;
    ...
    public static void checkLanguageVersion(int i) {
        ...
        vs.m(a82.j(i, "Bad language version: "));
    }
    ...
    public static void checkOptimizationLevel(int i) {
        ...
        vs.m(a82.j(i, "Optimization level outside [-1..9]: "));
    }

    private Evaluator createCompiler() {
        Evaluator evaluator;
        Class<?> cls;
        if (!this.interpretedMode && (cls = codegenClass) != null) {
        ...
        if (context2 == null) {
            if (context == null) {
                ...
                if (context.enterCount == 0) {
                    ...
                    vs.k("factory.makeContext() returned Context instance already associated with some thread");
                    return null;
                }
            } else if (context.enterCount != 0) {
                vs.k("can not use Context instance already associated with some thread");
                return null;
            }
    ...
    public static void exit() {
        ...
        vs.k("Calling Context.exit without previous Context.enter");
    }
    ...
    public static Context getContext() {
        ...
        cy7.e("No Context associated with current Thread");
        return null;
    }
    ...
    public static String getSourcePositionFromStack(int[] iArr) {
        ...
        return getSourcePositionFromJavaStack(iArr);
    }
    ...
    private ScriptNode parse(String str, String str2, int i, CompilerEnvirons compilerEnvirons, ErrorReporter errorReporter, boolean z) {
        ...
        if (z && (parse.getFirstChild() == null || parse.getFirstChild().getType() != 122)) {
            vs.m(s21.m("compileFunction only accepts source with single JS function: ", str));
            return null;
        }
        ScriptNode transformTree = new IRFactory(compilerEnvirons, str2, str, errorReporter).transformTree(parse);
    ...
    public Object callFunctionWithContinuations(Callable callable, Scriptable scriptable, Object[] objArr) {
        if (callable instanceof InterpretedFunction) {
            ...
            vs.k("Cannot have any pending top calls when executing a script with continuations");
            return null;
        }
        vs.m("Function argument was not created by interpreted mode ");
        return null;
    }
    ...
    public Object compileImpl(Scriptable scriptable, String str, String str2, int i, Object obj, boolean z, Evaluator evaluator, ErrorReporter errorReporter, Consumer<CompilerEnvirons> consumer) {
        ...
        if (obj != null && getSecurityController() == null) {
            vs.m("securityDomain should be null if setSecurityController() was never called");
            return null;
        }
        if (scriptable == null) {
            z2 = true;
        ...
        if (evaluator == null) {
            try {
                ...
                compile = createInterpreter.compile(compilerEnvirons, parse2, str, z);
            }
        } else {
            createCompiler = evaluator;
        }
        compile = createCompiler.compile(compilerEnvirons, parse, str, z);
        createInterpreter = createCompiler;
        ...
        if (z) {
            return createInterpreter.createFunctionObject(this, scriptable, compile, obj);
        }
        return createInterpreter.createScriptObject(compile, obj);
    }
    ...
    public final String decompileFunction(Function function, int i) {
        if (function instanceof BaseFunction) {
            return ((BaseFunction) function).decompile(i, EnumSet.noneOf(DecompilerFlag.class));
        }
        return hl5.n("function ", function.getClassName(), "() {\n\t[native code]\n}\n");
    }

    public final String decompileFunctionBody(Function function, int i) {
        if (function instanceof BaseFunction) {
            return ((BaseFunction) function).decompile(i, EnumSet.of(DecompilerFlag.ONLY_BODY));
        }
        return "[native code]\n";
    }
    ...
    public Object executeScriptWithContinuations(Script script, Scriptable scriptable) {
        ...
        vs.m("Script argument was not a script or was not created by interpreted mode ");
        return null;
    }
    ...
    public final void setApplicationClassLoader(ClassLoader classLoader) {
        ...
        if (classLoader == null) {
            ...
            vs.m("Loader can not resolve Rhino classes");
        }
    }
    ...
    public final void setMaximumInterpreterStackDepth(int i) {
        ...
        if (this.interpretedMode) {
            if (i >= 1) {
                ...
                vs.m("Cannot set maximumInterpreterStackDepth to less than 1");
                return;
            }
        }
        vs.k("Cannot set maximumInterpreterStackDepth outside interpreted mode");
    }
    ...
    public static Object call(ContextFactory contextFactory, Callable callable, Scriptable scriptable, Scriptable scriptable2, Object[] objArr) {
        ...
        return call(contextFactory, new j32(callable, scriptable, scriptable2, objArr));
    }
