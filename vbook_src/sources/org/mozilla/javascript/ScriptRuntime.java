...
public class ScriptRuntime {
    ...
    public static Object add(Object obj, Object obj2, Context context) {
        CharSequence scriptRuntime;
        CharSequence scriptRuntime2;
        Object addValues;
        Object addValues2;
        ...
        if (z) {
            scriptRuntime = (CharSequence) primitive;
        } else {
            scriptRuntime = toString(primitive);
        }
        if (primitive2 instanceof CharSequence) {
            scriptRuntime2 = (CharSequence) primitive2;
        } else {
            scriptRuntime2 = toString(primitive2);
        }
        return new ConsString(scriptRuntime, scriptRuntime2);
    }
    ...
    public static long advanceStringIndex(String str, long j, boolean z) {
        ...
        return j + Character.charCount(str.codePointAt((int) j));
    }
    ...
    public static Object applyOrCall(boolean z, Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objArr) {
        ...
        Scriptable applyOrCallThis = getApplyOrCallThis(context, scriptable, obj, length);
        if (z) {
            if (length <= 1) {
                objArr2 = emptyArgs;
            } else {
        ...
        return callable.call(context, scriptable, applyOrCallThis, objArr2);
    }
    ...
    */
    ...
    public static Number bitwiseAND(Number number, Number number2) {
        ...
        if (!z && !(number2 instanceof BigInteger)) {
            ...
            return Double.valueOf(toInt32(number.doubleValue()) & toInt32(number2.doubleValue()));
        }
        throw typeErrorById("msg.cant.convert.to.number", "BigInt");
    }
    ...
    public static Number bitwiseNOT(Number number) {
        ...
        return Double.valueOf(~toInt32(number.doubleValue()));
    }
    ...
    public static Ref callRef(Callable callable, Scriptable scriptable, Object[] objArr, Context context) {
        if (callable instanceof RefCallable) {
            ...
            vs.k(refCallable.getClass().getName().concat(".refCall() returned null"));
            return null;
        }
    ...
    public static String defaultObjectToSource(Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objArr) {
        ...
        if (set == null) {
            ...
            contains = set.contains(scriptable2);
            z = false;
        }
    ...
    public static String defaultObjectToString(Scriptable scriptable) {
        ...
        if (property instanceof CharSequence) {
            return hl5.n("[object ", String.valueOf(property), "]");
        }
        return hl5.n("[object ", scriptable.getClassName(), "]");
    }
    ...
    public static Number divide(Number number, Number number2) {
        ...
        } else if (!z && !(number2 instanceof BigInteger)) {
    ...
    private static Object doScriptableIncrDecr(Scriptable scriptable, String str, Scriptable scriptable2, Object obj, int i) {
        ...
        if (obj instanceof Number) {
            ...
            numeric = toNumeric(obj);
        }
        if (numeric instanceof BigInteger) {
            if ((i & 1) == 0) {
                valueOf = ((BigInteger) numeric).add(BigInteger.ONE);
            } else {
                valueOf = ((BigInteger) numeric).subtract(BigInteger.ONE);
            }
        } else if (numeric instanceof Integer) {
            if ((i & 1) == 0) {
                valueOf = Integer.valueOf(((Integer) numeric).intValue() + 1);
            } else {
                valueOf = Integer.valueOf(((Integer) numeric).intValue() - 1);
            }
        } else if ((i & 1) == 0) {
            valueOf = Double.valueOf(numeric.doubleValue() + 1.0d);
        } else {
            valueOf = Double.valueOf(numeric.doubleValue() - 1.0d);
        }
        scriptable.put(str, scriptable2, valueOf);
        if (z) {
            return numeric;
        }
        return valueOf;
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [org.mozilla.javascript.xml.XMLLib, org.mozilla.javascript.Scriptable] */
    ...
    public static Object elemIncrDecr(Object obj, Object obj2, Context context, Scriptable scriptable, int i) {
        ...
        if (objectElem instanceof Number) {
            numeric = (Number) objectElem;
        } else {
            numeric = toNumeric(objectElem);
        }
        if (numeric instanceof BigInteger) {
            if ((i & 1) == 0) {
                valueOf = ((BigInteger) numeric).add(BigInteger.ONE);
        ...
        setObjectElem(obj, obj2, valueOf, context, scriptable);
        if (z) {
            return numeric;
        }
        return valueOf;
    ...
    public static Object enumInit(Object obj, Context context, Scriptable scriptable, int i) {
        boolean z = false;
        IdEnumeration idEnumeration = new IdEnumeration(0);
        Scriptable objectOrNull = toObjectOrNull(context, obj, scriptable);
        ...
        if (objectOrNull != null) {
            ...
            idEnumeration.iterator = null;
            if (i != 3 && i != 4 && i != 5) {
                Scriptable parentScope = objectOrNull.getParentScope();
                Scriptable scriptable2 = idEnumeration.obj;
                if (i == 0) {
                    z = true;
                }
                idEnumeration.iterator = toIterator(context, parentScope, scriptable2, z);
            }
            if (idEnumeration.iterator == null) {
    ...
    private static Object enumInitInOrder(Context context, IdEnumeration idEnumeration) {
        ...
        if (scriptable instanceof SymbolScriptable) {
            ...
            if (ScriptableObject.hasProperty(scriptable, symbolKey)) {
                ...
                Scriptable scriptable2 = idEnumeration.obj;
                if (z) {
                    Object call = ((Callable) property).call(context, scriptable2.getParentScope(), idEnumeration.obj, new Object[0]);
                ...
                if (hashSet == null || !hashSet.contains(obj2)) {
                    if (obj2 instanceof Symbol) {
                        ...
                        if (scriptable4.has(intValue, scriptable4)) {
                            ...
                            idEnumeration.currentId = valueOf;
                        }
                    }
                }
            }
    ...
    public static boolean eq(Object obj, Object obj2) {
        ...
        if (obj != null && !Undefined.isUndefined(obj)) {
            ...
            if (obj instanceof Boolean) {
                ...
                if (obj2 instanceof Boolean) {
                    ...
                    return true;
                } else if ((obj2 instanceof ScriptableObject) && (equivalentValues6 = ((ScriptableObject) obj2).equivalentValues(obj)) != Scriptable.NOT_FOUND) {
            ...
            } else if (isSymbol(obj) && isObject(obj2)) {
                ...
                if (obj instanceof Scriptable) {
                    ...
                    if (obj2 != null && !Undefined.isUndefined(obj2)) {
                        if (obj2 instanceof Scriptable) {
                            if ((obj instanceof ScriptableObject) && (equivalentValues5 = ((ScriptableObject) obj).equivalentValues(obj2)) != Scriptable.NOT_FOUND) {
                                return ((Boolean) equivalentValues5).booleanValue();
                            }
                            if ((obj2 instanceof ScriptableObject) && (equivalentValues4 = ((ScriptableObject) obj2).equivalentValues(obj)) != Scriptable.NOT_FOUND) {
                            ...
                            if ((obj instanceof ScriptableObject) && (equivalentValues3 = ((ScriptableObject) obj).equivalentValues(obj2)) != Scriptable.NOT_FOUND) {
        ...
        } else if (obj2 == null || Undefined.isUndefined(obj2)) {
            return true;
        } else {
    ...
    */
    ...
    public static Object evalSpecial(Context context, final Scriptable scriptable, Object obj, Object[] objArr, String str, int i) {
        ...
        if (createInterpreter != null) {
            Script compileString = context.compileString(obj2.toString(), createInterpreter, forEval, makeUrlForGeneratedScript, 1, null, new Consumer() { // from class: m1a
                @Override // java.util.function.Consumer
                public final void accept(Object obj3) {
                    ScriptRuntime.lambda$evalSpecial$0(Scriptable.this, (CompilerEnvirons) obj3);
                }
            });
            createInterpreter.setEvalScriptFlag(compileString);
            Callable callable = (Callable) compileString;
            ...
            if (i == 0) {
                if (obj instanceof Symbol) {
                    ...
                    if (obj instanceof Integer) {
                        ...
                        if (num2.intValue() >= 0) {
                            scriptable.put(num2.intValue(), scriptable, obj2);
                        }
                    }
                    StringIdOrIndex stringIdOrIndex = toStringIdOrIndex(obj);
                    String str = stringIdOrIndex.stringId;
                    if (str == null) {
                        scriptable.put(stringIdOrIndex.index, scriptable, obj2);
                    } else {
                        boolean isSpecialProperty = isSpecialProperty(str);
                        String str2 = stringIdOrIndex.stringId;
                        if (isSpecialProperty) {
                            specialRef(scriptable, str2, context, scriptable2).set(context, scriptable2, obj2);
                        } else {
                            scriptable.put(str2, scriptable, obj2);
                        }
                    }
                }
            } else {
                ...
                scriptableObject.setGetterOrSetter(obj, intValue, callable, z);
            }
        }
    }
    ...
    public static Scriptable getApplyOrCallThis(Context context, Scriptable scriptable, Object obj, int i) {
        Scriptable scriptable2;
        if (i != 0) {
            if (obj == Undefined.instance && !context.hasFeature(15)) {
                scriptable2 = Undefined.SCRIPTABLE_UNDEFINED;
            } else {
        ...
        if (scriptable2 == null && context.hasFeature(15)) {
            return getTopCallScope(context);
        }
        return scriptable2;
    }
    ...
    public static Object getIndexObject(String str) {
        ...
        if (indexFromString >= 0 && indexFromString <= 2147483647L) {
    ...
    public static Object getObjectIndex(Object obj, double d, Context context, Scriptable scriptable) {
        Scriptable asScriptableOrThrowUndefReadError = asScriptableOrThrowUndefReadError(context, scriptable, obj, Double.valueOf(d));
        int i = (int) d;
        if (i == d && i >= 0) {
            return getObjectIndex(asScriptableOrThrowUndefReadError, i, context);
        }
        return getObjectProp(asScriptableOrThrowUndefReadError, toString(d), context);
    }
    ...
    public static Object getSuperIndex(Object obj, double d, Context context, Scriptable scriptable, Object obj2) {
        Scriptable asScriptableOrThrowUndefReadError = asScriptableOrThrowUndefReadError(context, scriptable, obj, Double.valueOf(d));
        Scriptable asScriptableOrThrowUndefReadError2 = asScriptableOrThrowUndefReadError(context, scriptable, obj2, Double.valueOf(d));
        int i = (int) d;
        if (i == d && i >= 0) {
            return getSuperIndex(asScriptableOrThrowUndefReadError, asScriptableOrThrowUndefReadError2, i);
        }
        return getSuperProp(asScriptableOrThrowUndefReadError, asScriptableOrThrowUndefReadError2, toString(d), context, false);
    }
    ...
    */
                    ...
                    if (paramAndVarCount != 0) {
                        ...
                        if (!ScriptableObject.hasProperty(scriptable2, paramOrVarName)) {
                            if (paramOrVarConst) {
                                ...
                                if (!(nativeFunction instanceof InterpretedFunction) || ((InterpretedFunction) nativeFunction).hasFunctionNamed(paramOrVarName)) {
    ...
    public static boolean isObject(Object obj) {
        ...
        if (obj instanceof ScriptableObject) {
            ...
            return true;
        } else if (!(obj instanceof Scriptable) || (obj instanceof Callable)) {
            return false;
        } else {
            return true;
        }
    ...
    public static /* synthetic */ void lambda$evalSpecial$0(Scriptable scriptable, CompilerEnvirons compilerEnvirons) {
        boolean z;
        if ((scriptable instanceof NativeCall) && ((NativeCall) scriptable).getHomeObject() != null) {
            z = true;
        } else {
            z = false;
        }
        compilerEnvirons.setAllowSuper(z);
    }
    ...
    public static boolean loadFromIterable(Context context, Scriptable scriptable, Object obj, BiConsumer<Object, Object> biConsumer) {
        ...
        Object callIterator = callIterator(obj, context, scriptable);
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (!(ensureScriptable instanceof Symbol)) {
                    ...
                    Object obj4 = ensureScriptable.get(1, ensureScriptable);
                    if (obj4 == obj3) {
                        obj4 = Undefined.instance;
                    }
                    biConsumer.accept(obj2, obj4);
                } else {
                    throw typeErrorById("msg.arg.not.object", typeof(ensureScriptable));
                }
            }
    ...
    public static Scriptable newArrayLiteral(Object[] objArr, int[] iArr, Context context, Scriptable scriptable) {
        ...
        while (i2 != i3) {
            if (i6 != i && iArr[i6] == i2) {
                ...
                newArray.put(i2, newArray, objArr[i7]);
                i7++;
            }
            i2++;
        }
    ...
    */
    ...
    public static Scriptable newObjectLiteral(Object[] objArr, Object[] objArr2, Context context, Scriptable scriptable) {
        ...
        fillObjectLiteral(newObject, objArr, objArr2, null, context, scriptable);
        return newObject;
    }
    ...
    public static RuntimeException notFunctionError(Object obj, Object obj2, String str) {
        ...
        if ((obj instanceof NativeFunction) && (indexOf = scriptRuntime.indexOf(Token.EXPORT, scriptRuntime.indexOf(41))) > -1) {
            scriptRuntime = scriptRuntime.substring(0, indexOf + 1).concat("...}");
        }
        if (obj2 == Scriptable.NOT_FOUND) {
            return typeErrorById("msg.function.not.found.in", str, scriptRuntime);
        }
        return typeErrorById("msg.isnt.function.in", str, scriptRuntime, typeof(obj2));
    }
    ...
    public static Object propIncrDecr(Object obj, String str, Context context, Scriptable scriptable, int i) {
        Scriptable asScriptableOrThrowUndefReadError = asScriptableOrThrowUndefReadError(context, scriptable, obj, str);
        Scriptable scriptable2 = asScriptableOrThrowUndefReadError;
        do {
            Object obj2 = scriptable2.get(str, asScriptableOrThrowUndefReadError);
            if (obj2 != Scriptable.NOT_FOUND) {
                return doScriptableIncrDecr(scriptable2, str, asScriptableOrThrowUndefReadError, obj2, i);
            }
            scriptable2 = scriptable2.getPrototype();
        } while (scriptable2 != null);
        Double d = NaNobj;
        asScriptableOrThrowUndefReadError.put(str, asScriptableOrThrowUndefReadError, d);
        return d;
    }
    ...
    public static Object refIncrDecr(Ref ref, Context context, Scriptable scriptable, int i) {
        ...
        ref.set(context, scriptable, valueOf);
        if (z) {
            return numeric;
        }
        return valueOf;
    ...
    public static Object setObjectIndex(Object obj, double d, Object obj2, Context context, Scriptable scriptable) {
        Scriptable asScriptableOrThrowUndefWriteError = asScriptableOrThrowUndefWriteError(context, scriptable, obj, Double.valueOf(d), obj2);
        int i = (int) d;
        if (i == d && i >= 0) {
            return setObjectIndex(asScriptableOrThrowUndefWriteError, i, obj2, context);
        }
        return setObjectProp(asScriptableOrThrowUndefWriteError, toString(d), obj2, context);
    }
    ...
    public static Object setSuperIndex(Object obj, double d, Object obj2, Context context, Scriptable scriptable, Object obj3) {
        Scriptable asScriptableOrThrowUndefWriteError = asScriptableOrThrowUndefWriteError(context, scriptable, obj, Double.valueOf(d), obj2);
        Scriptable asScriptableOrThrowUndefWriteError2 = asScriptableOrThrowUndefWriteError(context, scriptable, obj3, Double.valueOf(d), obj2);
        int i = (int) d;
        if (i == d && i >= 0) {
            return setSuperIndex(asScriptableOrThrowUndefWriteError, asScriptableOrThrowUndefWriteError2, i, obj2, context);
        }
        return setSuperProp(asScriptableOrThrowUndefWriteError, asScriptableOrThrowUndefWriteError2, toString(d), obj2, context);
    }
    ...
    */
    ...
    public static Number subtract(Number number, Number number2) {
        ...
        if (!z && !(number2 instanceof BigInteger)) {
            if ((number instanceof Integer) && (number2 instanceof Integer)) {
                return subtract((Integer) number, (Integer) number2);
            }
            return Double.valueOf(number.doubleValue() - number2.doubleValue());
        }
        throw typeErrorById("msg.cant.convert.to.number", "BigInt");
    ...
    public static BigInteger toBigInt(Object obj) {
        ...
        if (primitive instanceof Number) {
            ...
            throw rangeErrorById("msg.cant.convert.to.bigint.isnt.integer", toString(primitive));
        } else if (primitive != null && !Undefined.isUndefined(primitive)) {
            ...
            if (primitive instanceof Boolean) {
                if (((Boolean) primitive).booleanValue()) {
                    return BigInteger.ONE;
                }
                return BigInteger.ZERO;
            } else if (isSymbol(primitive)) {
    ...
    public static int toIndex(Object obj) {
        ...
        if (integer >= 0.0d) {
            double min = Math.min(integer, 9.007199254740991E15d);
            if (integer == min) {
                return (int) min;
            }
    ...
    public static Scriptable toIterator(Context context, Scriptable scriptable, Scriptable scriptable2, boolean z) {
        ...
        if (ScriptableObject.hasProperty(scriptable2, NativeIterator.ITERATOR_PROPERTY_NAME)) {
            ...
            if (property instanceof Callable) {
                ...
                Object call = callable.call(context, scriptable, scriptable2, new Object[]{bool});
                if (call instanceof Scriptable) {
    ...
    public static Number toNumeric(Object obj) {
        ...
        return Double.valueOf(toNumber(primitive));
    }
            ...
            if (!Undefined.isUndefined(obj)) {
                if (isSymbol(obj)) {
                    ...
                    if (obj instanceof CharSequence) {
                        ...
                        return nativeString;
                    } else if (context.getLanguageVersion() >= 200 && (obj instanceof BigInteger)) {
    ...
    public static Object toPrimitive(Object obj, Class<?> cls) {
        ...
        Scriptable scriptable = (Scriptable) obj;
        if (scriptable instanceof SymbolScriptable) {
            obj2 = ScriptableObject.getProperty(scriptable, SymbolKey.TO_PRIMITIVE);
        } else {
            obj2 = null;
        }
        if (obj2 instanceof Function) {
            ...
            Object call = function.call(currentContext, parentScope, scriptable, new Object[]{str});
            if (!isObject(call)) {
                return call;
            }
            throw typeErrorById("msg.cant.convert.to.primitive", new Object[0]);
        } else if (obj2 != null && obj2 != Scriptable.NOT_FOUND && !Undefined.isUndefined(obj2)) {
            throw notFunctionError(obj2);
        } else {
    ...
    public static StringIdOrIndex toStringIdOrIndex(Object obj) {
        ...
        return new StringIdOrIndex(scriptRuntime);
    }
    ...
    */
    public static org.mozilla.javascript.Scriptable wrapException(java.lang.Throwable r11, org.mozilla.javascript.Scriptable r12, org.mozilla.javascript.Context r13) {
        ...
        L12:
            ...
            java.lang.String r5 = ": "
            java.lang.String r3 = defpackage.eub.o(r3, r5, r4)
            r10 = r2
            r2 = r0
            r0 = r10
            goto L56
    ...
    public static class DefaultMessageProvider implements MessageProvider {
        ...
        public String getMessage(String str, Object[] objArr) {
            ...
            try {
                ...
                cy7.e(s21.m("no message resource found for message property ", str));
                return null;
            }
        }
    ...
    public static Scriptable newObjectLiteral(Object[] objArr, Object[] objArr2, int[] iArr, Context context, Scriptable scriptable) {
        Scriptable newObject = context.newObject(scriptable);
        fillObjectLiteral(newObject, objArr, objArr2, iArr, context, scriptable);
        return newObject;
    }
    ...
    public static RuntimeException notFunctionError(Object obj, Object obj2) {
        ...
        if (obj == Scriptable.NOT_FOUND) {
            return typeErrorById("msg.function.not.found", obj3);
        }
        return typeErrorById("msg.isnt.function", obj3, typeof(obj));
    }

    public static Number multiply(Integer num, Integer num2) {
        long longValue = num2.longValue() * num.longValue();
    ...
    private static boolean eqBigInt(BigInteger bigInteger, double d) {
        if (!Double.isNaN(d) && !Double.isInfinite(d)) {
            ...
            if (ceil == d && new BigDecimal(bigInteger).compareTo(new BigDecimal(ceil, MathContext.UNLIMITED)) == 0) {
                return true;
            }
        }
        return false;
    ...
    public static BigInteger toBigInt(String str) {
        ...
        for (int i2 = 0; i2 != length; i2++) {
            ...
            if (!isStrWhiteSpaceChar(charAt)) {
                while (true) {
                    length--;
                    if (!isStrWhiteSpaceChar(str.charAt(length))) {
                        break;
                    }
                }
                if (charAt == '0' && (i = i2 + 2) <= length) {
                    char charAt2 = str.charAt(i2 + 1);
                    int i3 = (charAt2 == 'x' || charAt2 == 'X') ? 16 : (charAt2 == 'o' || charAt2 == 'O') ? 8 : (charAt2 == 'b' || charAt2 == 'B') ? 2 : -1;
                    if (i3 != -1) {
                        try {
