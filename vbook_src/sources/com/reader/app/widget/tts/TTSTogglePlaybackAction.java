...
public final class TTSTogglePlaybackAction implements l5, p96 {
    public static final int $stable = 8;
    private final ye6 playerController$delegate = ipe.x(sk6.a, new vm(this, 5));
    ...
    public Object onAction(Context context, uy4 uy4Var, r5 r5Var, m42 m42Var) {
        ...
        if (AndroidTextToSpeechService.R && AndroidTextToSpeechService.S) {
            if (AndroidTextToSpeechService.R) {
                mfb mfbVar = ix3.a;
                ix3.a(ezb.a);
            }
        } else if (AndroidTextToSpeechService.R) {
            mfb mfbVar2 = ix3.a;
            ix3.a(fzb.a);
        } else {
            playerController.b();
