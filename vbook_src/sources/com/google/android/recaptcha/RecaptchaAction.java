...
public final class RecaptchaAction {
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof RecaptchaAction) && c16.i(this.action, ((RecaptchaAction) obj).action)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return s21.q(new StringBuilder("RecaptchaAction(action="), this.action, ")");
    }
    ...
    public static final class Companion {
        ...
        public /* synthetic */ Companion(ct2 ct2Var) {
            this();
        }
    }

    public /* synthetic */ RecaptchaAction(String str, ct2 ct2Var) {
        this(str);
    }
}
