...
public final class zzpz {
    ...
    public static zzml zza(long j) {
        ...
        hfd.k("Duration is not valid. See proto definition for valid values. Seconds (", zzg, ") must be in range [-315,576,000,000, +315,576,000,000]. Nanos (", zzf, ") must be in range [-999,999,999, +999,999,999]. Nanos must have the same sign as seconds");
        return null;
    }
}
