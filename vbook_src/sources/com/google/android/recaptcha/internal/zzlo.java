...
final class zzlo implements zzpy {
    ...
    public final void zzH(int i, List list) {
        ...
        if (list instanceof zznu) {
            ...
            while (i2 < list.size()) {
                ...
                zzln zzlnVar = this.zza;
                if (z) {
                    zzlnVar.zzp(i, (String) zzc);
                } else {
                    zzlnVar.zze(i, (zzle) zzc);
                }
                i2++;
            }
            return;
    ...
    public final void zzc(int i, List list, boolean z) {
        ...
        if (list instanceof zzkv) {
            ...
            if (z) {
                this.zza.zzr(i, 2);
                int i3 = 0;
                for (int i4 = 0; i4 < zzkvVar.size(); i4++) {
                    zzkvVar.zzf(i4);
                    i3++;
                }
                this.zza.zzt(i3);
    ...
    public final void zzg(int i, List list, boolean z) {
        ...
        if (list instanceof zzmi) {
            ...
            if (z) {
                this.zza.zzr(i, 2);
                int i3 = 0;
                for (int i4 = 0; i4 < zzmiVar.size(); i4++) {
                    zzmiVar.zze(i4);
                    i3 += 8;
                }
                this.zza.zzt(i3);
    ...
    public final void zzj(int i, List list, boolean z) {
        ...
        if (list instanceof zzne) {
            ...
            int i5 = 0;
            for (int i6 = 0; i6 < list.size(); i6++) {
                i5 += zzln.zzB(((Integer) list.get(i6)).intValue());
            }
            this.zza.zzt(i5);
            while (i2 < list.size()) {
    ...
    public final void zzp(int i, List list, boolean z) {
        ...
        if (list instanceof zzmv) {
            ...
            if (z) {
                this.zza.zzr(i, 2);
                int i3 = 0;
                for (int i4 = 0; i4 < zzmvVar.size(); i4++) {
                    zzmvVar.zze(i4);
                    i3 += 4;
                }
                this.zza.zzt(i3);
