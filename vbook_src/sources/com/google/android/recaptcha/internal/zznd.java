...
public abstract class zznd<MessageType extends zznd<MessageType, BuilderType>, BuilderType extends zzmx<MessageType, BuilderType>> extends zzko<MessageType, BuilderType> {
    ...
    public final int zza(zzow zzowVar) {
        if (zzL()) {
            ...
            vs.k(a82.j(zza, "serialized size must be non-negative, was "));
            return 0;
        }
        ...
        if (i == Integer.MAX_VALUE) {
            ...
            vs.k(a82.j(zza2, "serialized size must be non-negative, was "));
            return 0;
        }
        return i;
    }
    ...
    public final int zzo() {
        if (zzL()) {
            ...
            vs.k(a82.j(zzf, "serialized size must be non-negative, was "));
            return 0;
        }
        int i = this.zzd & Integer.MAX_VALUE;
        if (i != Integer.MAX_VALUE) {
        ...
        vs.k(a82.j(zzf2, "serialized size must be non-negative, was "));
        return 0;
    }
