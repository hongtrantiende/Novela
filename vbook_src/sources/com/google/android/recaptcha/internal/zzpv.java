...
public final class zzpv {
    ...
    */
    public static int zzb(java.lang.String r9, byte[] r10, int r11, int r12) {
        /*
                ...
                if (zzpt.zzd(b2)) {
                    ...
                    if (b2 < -32) {
                        if (i7 < i4) {
                            ...
                            hfd.q("Protocol message had invalid UTF-8.");
                            return null;
                        }
                    } else if (b2 < -16) {
                        if (i7 < i4 - 1) {
                        ...
                        int i9 = i + 3;
                        i += 4;
                        zzpt.zza(b2, bArr[i7], bArr[i + 2], bArr[i9], cArr, i6);
                        i6 += 2;
                    } else {
                        hfd.q("Protocol message had invalid UTF-8.");
                        return null;
