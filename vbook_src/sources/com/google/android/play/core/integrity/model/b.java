    ...
    public static String a(int i) {
        ...
        if (map.containsKey(valueOf)) {
            ...
            if (map2.containsKey(valueOf)) {
                return rs8.l((String) map.get(valueOf), " (https://developer.android.com/google/play/integrity/reference/com/google/android/play/core/integrity/model/StandardIntegrityErrorCode.html#", (String) map2.get(valueOf), ")");
            }
            return "";
        }
        return "";
