...
final class AutoValue_IconData extends IconData {
                ...
                if (str3 != null) {
                    ...
                    if (str4 != null) {
                        ...
                        if (list != null) {
                            ...
                            xk5.k("Null fallbackImages");
                            throw null;
                        }
                    }
                    xk5.k("Null alternateText");
                    throw null;
                }
                xk5.k("Null imageUrl");
                throw null;
            }
            xk5.k("Null yPosition");
            throw null;
        }
        xk5.k("Null xPosition");
        throw null;
    }
    ...
    public String toString() {
        ...
        a82.t(i, i2, "IconData{id=", ", width=", sb);
        sb.append(", height=");
        sb.append(i3);
        ...
        sb.append(", imageUrl=");
        sb.append(str3);
        nk2.C(sb, ", alternateText=", str4, ", fallbackImages=", valueOf);
        sb.append("}");
        return sb.toString();
    }
