...
public abstract class cb7 {
    ...
    public static void b(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                c31 c31Var = c31.c;
                sb.append(dye.l(new c31(((String) obj).getBytes(wz5.a))));
                sb.append('\"');
            } else if (obj instanceof c31) {
                sb.append(": \"");
                sb.append(dye.l((c31) obj));
                sb.append('\"');
    ...
    */
    public static void c(defpackage.qw4 r21, java.lang.StringBuilder r22, int r23) {
        /*
            Method dump skipped, instructions count: 558
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cb7.c(qw4, java.lang.StringBuilder, int):void");
    }
}
