...
public final class oaf extends m7e {
    private static final oaf zzc;
    private static volatile k8e zzd;
    private int zze;

    /* JADX WARN: Type inference failed for: r0v0, types: [oaf, m7e] */
    static {
        ?? m7eVar = new m7e();
        zzc = m7eVar;
        m7e.j(oaf.class, m7eVar);
    }

    public static /* synthetic */ void u(oaf oafVar, int i) {
        oafVar.zze = i;
    }
