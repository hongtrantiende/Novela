...
public final class ya6 extends sm1 {
    public final /* synthetic */ int d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ ya6(int i, int i2, long j, String str) {
        super(str, j, i);
        this.d = i2;
    }
    ...
    public final long d(float f, float f2, float f3) {
        ...
        switch (this.d) {
            case 0:
                ...
                floatToRawIntBits = Float.floatToRawIntBits(f5 * dye.i[1]);
    ...
    public final long f(float f, float f2, float f3, float f4, sm1 sm1Var) {
        ...
        switch (this.d) {
            case 0:
                ...
                return sve.a(f11, f12, f14, f4, sm1Var);
            default:
                if (f < -2.0f) {
                    f = -2.0f;
                }
                ...
                return sve.a(f, f2, f15, f4, sm1Var);
        }
    }
}
