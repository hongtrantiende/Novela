...
public final class yk1 extends xb1 {
    public int C;
    public final int D;
    public int E;
    public int F;
    ...
    public yk1(byte[] bArr, int i, int i2, boolean z) {
        super(1, (byte) 0);
    ...
    public final String z() {
        ...
        if (o0 > 0) {
            ...
            int i2 = this.C;
            if (o0 <= i - i2) {
                String str = new String(this.d, i2, o0, uz5.a);
                this.C += o0;
                return str;
            }
        }
