        ...
        if (length != 0) {
            ...
            while (true) {
                ...
                if (i3 <= i) {
                    ...
                    StaticLayout a = mw.a(text, (Layout.Alignment) e(textView, Layout.Alignment.ALIGN_NORMAL, "getLayoutAlignment"), Math.round(rectF.right), maxLines, textView, this.h, this.k);
            ...
            vs.k("No available text sizes to choose from.");
            return 0;
        }
    }
    ...
    public final void i(float f, float f2, float f3) {
        if (f > nae.e) {
            if (f2 > f) {
                ...
                vs.m(a82.k("The auto-size step granularity (", f3, "px) is less or equal to (0px)"));
                return;
            }
            vs.m(a82.l("Maximum auto-size text size (", f2, "px) is less or equal to minimum auto-size text size (", f, "px)"));
            return;
        }
        vs.m(a82.k("Minimum auto-size text size (", f, "px) is less or equal to (0px)"));
    }
}
