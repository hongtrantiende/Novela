...
public final class uif extends m7e {
    private static final uif zzc;
    private static volatile k8e zzd;
    private int zze;

    /* JADX WARN: Type inference failed for: r0v0, types: [uif, m7e] */
    static {
        ?? m7eVar = new m7e();
        zzc = m7eVar;
        m7e.j(uif.class, m7eVar);
    }

    public static /* synthetic */ void u(uif uifVar, int i) {
        uifVar.zze = i;
    }
