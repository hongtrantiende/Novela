...
public final class ux4 {
    ...
    public ux4(String str, String str2, String str3, int i, String str4, String str5, String str6, String str7, int i2, boolean z, boolean z2, boolean z3, long j, long j2) {
        this.a = str;
        this.b = str2;
        this.c = str3;
        this.d = i;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof ux4) {
                ux4 ux4Var = (ux4) obj;
                if (!this.a.equals(ux4Var.a) || !this.b.equals(ux4Var.b) || !this.c.equals(ux4Var.c) || this.d != ux4Var.d || !this.e.equals(ux4Var.e) || !this.f.equals(ux4Var.f) || !this.g.equals(ux4Var.g) || !this.h.equals(ux4Var.h) || this.i != ux4Var.i || this.j != ux4Var.j || this.k != ux4Var.k || this.l != ux4Var.l || this.m != ux4Var.m || this.n != ux4Var.n) {
                    return false;
                }
                return true;
            }
    ...
    public final String toString() {
        StringBuilder y = nk2.y("GetInstalledExtension(id=", this.a, ", name=", this.b, ", author=");
