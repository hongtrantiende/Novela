...
public final class ta4 implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float f4 = fArr[min];
        return a82.c(fArr[min + 1], f4, f3, f4);
    }
}
