...
public final class b99 extends g3 {
    public static final b99 d;
    public Object[] b;
    public int c;

    static {
        b99 b99Var = new b99(new Object[0], 0);
        d = b99Var;
        b99Var.a = false;
    }

    public b99(Object[] objArr, int i) {
        this.b = objArr;
        this.c = i;
    }
    ...
    public final g3 b(int i) {
        if (i >= this.c) {
            return new b99(Arrays.copyOf(this.b, i), this.c);
        }
        p1a.g();
        return null;
    }
