...
public class w7e extends IOException {
    public boolean a;

    /* JADX WARN: Type inference failed for: r0v0, types: [y7e, java.io.IOException] */
    public static y7e a() {
        return new IOException("Protocol message tag had invalid wire type.");
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [w7e, java.io.IOException] */
    public static w7e b() {
