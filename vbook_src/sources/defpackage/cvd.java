...
public abstract class cvd {
    public static final jla a = new jla(0);
    ...
    public static String c(Context context) {
        ...
        try {
            Context context2 = (Context) wnd.a(context).a;
    ...
    public static String e(Context context, String str) {
        ...
        synchronized (jlaVar) {
            try {
                Locale a2 = pv6.c(context.getResources().getConfiguration().getLocales()).a(0);
                if (!a2.equals(b)) {
                    jlaVar.clear();
                    b = a2;
                }
                String str2 = (String) jlaVar.get(str);
                if (str2 != null) {
                    return str2;
                }
                int i = s05.e;
