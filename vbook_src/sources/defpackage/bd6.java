...
public final class bd6 {
    ...
    public bd6(CharSequence charSequence, TextPaint textPaint, int i) {
        this.a = charSequence;
        this.b = textPaint;
        this.c = i;
    }
    ...
    public final BoringLayout.Metrics a() {
        ...
        if (!this.g) {
            TextDirectionHeuristic b = ivb.b(this.c);
            int i = Build.VERSION.SDK_INT;
            CharSequence charSequence = this.a;
            TextPaint textPaint = this.b;
            if (i >= 33) {
                metrics = r4.q(charSequence, textPaint, b);
    ...
    public final CharSequence b() {
        ...
        if (charSequence == null) {
            ...
            if (charSequence2 instanceof Spanned) {
                ...
                if (fce.w(spanned, CharacterStyle.class)) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x004f, code lost:
        if (defpackage.fce.w(r2, defpackage.sl6.class) == false) goto L21;
     */
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0057, code lost:
        if (r3.getLetterSpacing() == defpackage.nae.e) goto L23;
     */
    /*
    ...
    */
    public final float c() {
        ...
        L39:
            ...
            java.lang.Class<tl6> r4 = defpackage.tl6.class
            boolean r4 = defpackage.fce.w(r2, r4)
            if (r4 != 0) goto L5a
            java.lang.Class<sl6> r4 = defpackage.sl6.class
            boolean r2 = defpackage.fce.w(r2, r4)
            if (r2 != 0) goto L5a
        L51:
        ...
        L5d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bd6.c():float");
    }
}
