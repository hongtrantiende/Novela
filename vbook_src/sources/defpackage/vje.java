...
public final class vje extends ehe {
    public final dke f;
    public final xk9 g;
    public final hlf h;
    public final Integer i;

    public vje(dke dkeVar, xk9 xk9Var, hlf hlfVar, Integer num) {
        this.f = dkeVar;
        this.g = xk9Var;
        this.h = hlfVar;
        this.i = num;
    ...
    public static vje E(yhe yheVar, xk9 xk9Var, Integer num) {
        hlf b;
        ...
        if (yheVar == yheVar2 && num != null) {
            ...
            return new vje(dkeVar, xk9Var, b, num);
        } else {
            throw new GeneralSecurityException(a82.j(hlfVar.a.length, "ChaCha20Poly1305 key must be constructed with key of length 32 bytes, not "));
        }
    }
