...
public final class v4 {
    ...
    public v4(AccessibilityNodeInfo accessibilityNodeInfo) {
    ...
    public final void b(q4 q4Var) {
        this.a.addAction((AccessibilityNodeInfo.AccessibilityAction) q4Var.a);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.c == v4Var.c && this.b == v4Var.b) {
            return true;
        }
        return false;
    }
    ...
    public final CharSequence f() {
        ...
        if (!isEmpty) {
            ...
            for (int i = 0; i < c.size(); i++) {
                spannableString.setSpan(new h4(((Integer) c4.get(i)).intValue(), this, accessibilityNodeInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer) c.get(i)).intValue(), ((Integer) c2.get(i)).intValue(), ((Integer) c3.get(i)).intValue());
            }
    ...
    public final String toString() {
        ...
        if (i3 >= 34) {
            k4.k(accessibilityNodeInfo, rect);
        } else {
        ...
        if (i3 >= 30) {
            charSequence = qka.h(accessibilityNodeInfo);
        } else {
        ...
        if (i3 >= 36) {
            charSequence2 = s4.c(accessibilityNodeInfo);
        } else {
        ...
        sb.append("; uniqueId: ");
        if (i3 >= 33) {
            string = r4.p(accessibilityNodeInfo);
        } else {
        ...
        if (i3 >= 34) {
            charSequence4 = k4.l(accessibilityNodeInfo);
        } else {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            arrayList.add(new q4(actionList.get(i4), 0, null, null, null));
        }
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            q4 q4Var = (q4) arrayList.get(i5);
            int a = q4Var.a();
            Object obj = q4Var.a;
            String d2 = d(a);
