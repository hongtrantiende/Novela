...
public final /* synthetic */ class tc9 implements xt4 {
    ...
    public /* synthetic */ tc9(Map map, LinkedHashMap linkedHashMap, be9 be9Var, String str, int i) {
        this.a = i;
        this.b = map;
        ...
        switch (i) {
            case 0:
                ...
                for (Map.Entry entry : map.entrySet()) {
                    ...
                    gk2Var.E0(new cp2(B, this.e, str, str2, 1, 0, b, by5.a.k().b()));
                }
                return pvcVar;
            default:
                ((vjc) obj).getClass();
                for (Map.Entry entry2 : map.entrySet()) {
                    ...
                    gk2Var2.E0(new cp2(B2, this.e, str3, str4, 0, 0, b2, by5.a.k().b()));
                }
                return pvcVar;
        }
    }
