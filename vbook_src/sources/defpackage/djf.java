...
public final class djf extends m7e {
    private static final djf zzc;
    private static volatile k8e zzd;
    private int zze;

    /* JADX WARN: Type inference failed for: r0v0, types: [djf, m7e] */
    static {
        ?? m7eVar = new m7e();
        zzc = m7eVar;
        m7e.j(djf.class, m7eVar);
    }

    public static djf u(s6e s6eVar, g7e g7eVar) {
        return (djf) m7e.h(zzc, s6eVar, g7eVar);
    }
