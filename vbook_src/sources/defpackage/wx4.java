...
public final class wx4 {
    ...
    public wx4(String str, String str2, String str3, int i, String str4, String str5, String str6, String str7, int i2, boolean z, boolean z2, boolean z3, long j, long j2) {
        this.a = str;
        this.b = str2;
        this.c = str3;
        this.d = i;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof wx4) {
                wx4 wx4Var = (wx4) obj;
                if (!this.a.equals(wx4Var.a) || !this.b.equals(wx4Var.b) || !this.c.equals(wx4Var.c) || this.d != wx4Var.d || !this.e.equals(wx4Var.e) || !this.f.equals(wx4Var.f) || !this.g.equals(wx4Var.g) || !this.h.equals(wx4Var.h) || this.i != wx4Var.i || this.j != wx4Var.j || this.k != wx4Var.k || this.l != wx4Var.l || this.m != wx4Var.m || this.n != wx4Var.n) {
                    return false;
                }
                return true;
            }
    ...
    public final String toString() {
        StringBuilder y = nk2.y("GetReadExtension(id=", this.a, ", name=", this.b, ", author=");
