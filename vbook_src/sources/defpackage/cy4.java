...
public final class cy4 {
    ...
    public cy4(String str, String str2, String str3, int i, String str4, String str5, String str6, String str7, int i2, boolean z, boolean z2, boolean z3, long j, long j2) {
        this.a = str;
        this.b = str2;
        this.c = str3;
        this.d = i;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof cy4) {
                cy4 cy4Var = (cy4) obj;
                if (!this.a.equals(cy4Var.a) || !this.b.equals(cy4Var.b) || !this.c.equals(cy4Var.c) || this.d != cy4Var.d || !this.e.equals(cy4Var.e) || !this.f.equals(cy4Var.f) || !this.g.equals(cy4Var.g) || !this.h.equals(cy4Var.h) || this.i != cy4Var.i || this.j != cy4Var.j || this.k != cy4Var.k || this.l != cy4Var.l || this.m != cy4Var.m || this.n != cy4Var.n) {
                    return false;
                }
                return true;
            }
    ...
    public final String toString() {
        StringBuilder y = nk2.y("GetTTSExtension(id=", this.a, ", name=", this.b, ", author=");
