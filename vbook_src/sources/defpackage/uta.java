...
public final class uta {
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof uta) {
                uta utaVar = (uta) obj;
                if (!this.a.equals(utaVar.a) || !this.b.equals(utaVar.b) || !this.c.equals(utaVar.c) || !this.d.equals(utaVar.d)) {
                    return false;
                }
                return true;
            }
    ...
    public final String toString() {
        return nk2.w(nk2.y("SourceExploreAction(type=", this.a, ", name=", this.b, ", script="), this.c, ", input=", this.d, ")");
    }
}
