...
public abstract class ab7 {
    ...
    public static void b(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                a31 a31Var = a31.c;
                sb.append(aye.g(new a31(((String) obj).getBytes(uz5.a))));
                sb.append('\"');
            } else if (obj instanceof a31) {
                sb.append(": \"");
                sb.append(aye.g((a31) obj));
                sb.append('\"');
            } else if (obj instanceof ow4) {
                sb.append(" {");
                c((ow4) obj, sb, i + 2);
                sb.append("\n");
                a(i, sb);
    ...
    */
    public static void c(defpackage.ow4 r21, java.lang.StringBuilder r22, int r23) {
        /*
            Method dump skipped, instructions count: 558
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ab7.c(ow4, java.lang.StringBuilder, int):void");
    }
}
