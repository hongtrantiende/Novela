...
public final class pmb {
    ...
    public pmb(String str, String str2, int i, String str3, int i2, String str4, String str5, String str6, int i3, int i4, long j) {
        s21.B(str, str2, str4, str5, str6);
        this.a = str;
        this.b = str2;
        this.c = i;
        this.d = str3;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof pmb) {
                pmb pmbVar = (pmb) obj;
                if (!c16.i(this.a, pmbVar.a) || !c16.i(this.b, pmbVar.b) || this.c != pmbVar.c || !this.d.equals(pmbVar.d) || this.e != pmbVar.e || !c16.i(this.f, pmbVar.f) || !c16.i(this.g, pmbVar.g) || !c16.i(this.h, pmbVar.h) || this.i != pmbVar.i || this.j != pmbVar.j || this.k != pmbVar.k) {
                    return false;
                }
                return true;
            }
    ...
    public final String toString() {
        StringBuilder y = nk2.y("TextBookmark(id=", this.a, ", bookId=", this.b, ", chapterIndex=");
