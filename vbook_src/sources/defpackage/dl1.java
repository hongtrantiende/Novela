...
public final class dl1 extends xb1 {
    public int C;
    public int D;
    public int E;
    public int F;
    ...
    public dl1(InputStream inputStream) {
        super(3, (byte) 0);
    ...
    public final boolean x0(int i) {
        ...
        if (i3 > i4) {
            ...
            if (i <= (Integer.MAX_VALUE - i5) - i2 && i5 + i2 + i <= this.G) {
                ...
                int i6 = this.f;
                try {
                    int read = inputStream.read(bArr, i6, Math.min(bArr.length - i6, (Integer.MAX_VALUE - this.F) - i6));
                    if (read != 0 && read >= -1 && read <= bArr.length) {
                        ...
                        vs.h(read, inputStream.getClass());
                        return false;
                    }
                } catch (q16 e) {
                    e.a = true;
    ...
    public final String z() {
        ...
        if (r0 > 0) {
            ...
            int i2 = this.D;
            if (r0 <= i - i2) {
                String str = new String(bArr, i2, r0, wz5.a);
                this.D += r0;
                return str;
            }
        }
        ...
        if (r0 >= 0) {
            if (r0 <= this.f) {
                v0(r0);
                String str2 = new String(bArr, this.D, r0, wz5.a);
                this.D += r0;
                return str2;
            }
            return new String(m0(r0), wz5.a);
        }
        throw q16.d();
    }
}
