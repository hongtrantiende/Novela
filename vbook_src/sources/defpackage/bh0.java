...
public final class bh0 {
    public static final int[] a = dye.e("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=");

    static {
        dye.e("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=");
    }
    ...
    public static byte[] a(String str) {
        ...
        int i5;
        int i6 = 0;
        String N = r4b.N(r4b.N(r4b.N(r4b.N(str, false, " ", ""), false, "\n", ""), false, "\r", ""), false, "\t", "");
        int length = N.length();
        byte[] bArr = new byte[length];
        for (int i7 = 0; i7 < length; i7++) {
            bArr[i7] = (byte) N.charAt(i7);
        }
    ...
    public static String b(byte[] bArr) {
        ...
        if (length != 1) {
            if (length == 2) {
                ...
                sb.append("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(i3 >>> 10));
                sb.append("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt((i3 >>> 4) & 63));
                sb.append("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt((i3 << 2) & 63));
                sb.append('=');
            }
        } else {
            int i4 = bArr[i] & 255;
