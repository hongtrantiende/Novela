...
public final class d97 implements xt4 {
    public static final d97 a = new Object();

    @Override // defpackage.xt4
    /* renamed from: a */
    public final MemberAccessor invoke(MemberAccessor memberAccessor) {
        MemberAccessor executableAccessor;
        gi1 a2 = cm9.a(MethodAccessor.class);
        if (a2.equals(cm9.a(FieldAccessor.class))) {
            ...
            cp8.u(cm9.a(MethodAccessor.class), "Unsupported accessor type: ");
            return null;
        }
        return (MethodAccessor) executableAccessor;
    }
}
