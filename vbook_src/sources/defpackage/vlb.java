...
public final class vlb extends Canvas {
    public Canvas a;
    ...
    public final Canvas a() {
        ...
        mv5.d("Text drawing wrapper is missing a Canvas!");
        ls2.c();
        return null;
    }
    ...
    public final void drawDoubleRoundRect(RectF rectF, float[] fArr, RectF rectF2, float[] fArr2, Paint paint) {
        ff.i(a(), rectF, fArr, rectF2, fArr2, paint);
    }
    ...
    public final void drawTextRun(MeasuredText measuredText, int i, int i2, int i3, int i4, float f, float f2, boolean z, Paint paint) {
        ff.k(a(), measuredText, i, i2, i3, i4, f, f2, z, paint);
    }
