...
public enum ate implements a7e {
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_SMART_REPLY_CLOSE(0),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_LANGUAGE_IDENTIFICATION_LOAD(1),
    /* JADX INFO: Fake field, exist only in values array */
    ...
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_IMAGE_LABEL_DETECT(Token.EMPTY),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_IMAGE_LABEL_CREATE(Token.COMPUTED_PROPERTY),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_SMART_REPLY_LOAD(Token.BLOCK),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_SMART_REPLY_CLOSE(Token.LABEL),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_LANGUAGE_IDENTIFICATION_LOAD(Token.TYPEOFNAME),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_SMART_REPLY_LOAD(Token.USE_STACK),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_SMART_REPLY_CLOSE(Token.SETPROP_OP),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_LANGUAGE_IDENTIFICATION_LOAD(Token.SETELEM_OP),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_SMART_REPLY_LOAD(Token.LOCAL_BLOCK),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_DETECT(Token.XMLATTR),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_CREATE(Token.XMLEND),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_LANGUAGE_IDENTIFICATION_LOAD(Token.TO_DOUBLE),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_CLOSE(Token.TO_OBJECT),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_TRANSLATOR_TRANSLATE(Token.ARRAYCOMP),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_TRANSLATOR_CREATE(Token.LETEXPR),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_TRANSLATOR_LOAD(Token.WITHEXPR),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_TRANSLATOR_CLOSE(Token.DEBUGGER),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_TRANSLATOR_DOWNLOAD(Token.COMMENT),
    /* JADX INFO: Fake field, exist only in values array */
    ...
    CLOUD_LOGO_CLOSE(93),
    /* JADX INFO: Fake field, exist only in values array */
    CLOUD_SAFE_SEARCH_CREATE(Token.ASSIGN_DIV),
    /* JADX INFO: Fake field, exist only in values array */
    CLOUD_SAFE_SEARCH_DETECT(Token.ASSIGN_MOD),
    /* JADX INFO: Fake field, exist only in values array */
    CLOUD_SAFE_SEARCH_CLOSE(Token.ASSIGN_EXP),
    /* JADX INFO: Fake field, exist only in values array */
    CLOUD_TEXT_CREATE(Token.DOT),
    /* JADX INFO: Fake field, exist only in values array */
    CLOUD_TEXT_DETECT(Token.FUNCTION),
    /* JADX INFO: Fake field, exist only in values array */
    CLOUD_TEXT_CLOSE(Token.EXPORT),
    /* JADX INFO: Fake field, exist only in values array */
    CLOUD_WEB_SEARCH_CREATE(Token.DO),
    /* JADX INFO: Fake field, exist only in values array */
    CLOUD_WEB_SEARCH_DETECT(Token.FOR),
    /* JADX INFO: Fake field, exist only in values array */
    CLOUD_WEB_SEARCH_CLOSE(Token.BREAK),
    /* JADX INFO: Fake field, exist only in values array */
    CUSTOM_MODEL_RUN(102),
    /* JADX INFO: Fake field, exist only in values array */
    CUSTOM_MODEL_CREATE(Token.ASSIGN_BITAND),
    /* JADX INFO: Fake field, exist only in values array */
    CUSTOM_MODEL_CLOSE(Token.ASSIGN_LOGICAL_AND),
    /* JADX INFO: Fake field, exist only in values array */
    CUSTOM_MODEL_LOAD(Token.ASSIGN_LSH),
    /* JADX INFO: Fake field, exist only in values array */
    AUTOML_IMAGE_LABELING_RUN(Token.TEMPLATE_CHARS),
    /* JADX INFO: Fake field, exist only in values array */
    AUTOML_IMAGE_LABELING_CREATE(Token.TEMPLATE_LITERAL_SUBST),
    /* JADX INFO: Fake field, exist only in values array */
    AUTOML_IMAGE_LABELING_CLOSE(Token.TAGGED_TEMPLATE_LITERAL),
    /* JADX INFO: Fake field, exist only in values array */
    AUTOML_IMAGE_LABELING_LOAD(Token.DOTDOTDOT),
    /* JADX INFO: Fake field, exist only in values array */
    MODEL_DOWNLOAD(100),
    /* JADX INFO: Fake field, exist only in values array */
    MODEL_UPDATE(101),
    ...
    /* JADX INFO: Fake field, exist only in values array */
    AGGREGATED_AUTO_ML_IMAGE_LABELING_INFERENCE(Context.VERSION_ES6),
    /* JADX INFO: Fake field, exist only in values array */
