...
@Composable
fun BookDetailCardBackgroundImageManageSheet(
    isDarkTheme: Boolean?,
    ...
    val selectImage =
        rememberLauncherForActivityResult(ActivityResultContracts.GetContent()) { uri ->
            uri?.let {
                scope.launch {
                    viewModel.setBookDetailCardBackgroundFromUri(
                        uri = it,
    ...
    AppModalBottomSheet(
        ...
        title = stringResource(R.string.bg_image_book_detail_card),
    ) { isDark ->
        ...
        Column(
            ...
            if (currentPath.isNullOrBlank()) {
                ...
                Box(
                    ...
                    SmallTonalButton(
                        onClick = { viewModel.removeBookDetailCardBackground(isDark) },
                        modifier = Modifier
