...
import io.legado.app.ui.main.homepage.modules.SpotlightModule
import io.legado.app.ui.main.homepage.modules.CoverFlowModule
                                ...
                                item(
                                    ...
                                    AnimatedVisibility(visible = true, enter = fadeIn()) {
                                        SpotlightModule(
                                            ...
                                            sharedTransitionScope = sharedTransitionScope,
                                            animatedVisibilityScope = animatedVisibilityScope,
                                            sharedCoverKeySourceId = "home:${moduleUi.globalId}:spotlight",
                                        )
                                    }
                                }
                            }
                                ...
                                item(
                                    ...
                                    AnimatedVisibility(visible = true, enter = fadeIn()) {
                                        CoverFlowModule(
                                            ...
                                            sharedTransitionScope = sharedTransitionScope,
                                            animatedVisibilityScope = animatedVisibilityScope,
                                            sharedCoverKeySourceId = "home:${moduleUi.globalId}:coverflow",
                                        )
                                    }
                                }
                            }
