...
fun AiConfigRouteScreen(
    ...
    AiConfigScreen(
        ...
        onNavigateToAiScanDict = onNavigateToAiScanDict
    )
}
        ...
        LazyColumn(
            ...
            item {
                SplicedColumnGroup(title = stringResource(R.string.ai_tasks)) {
                    ...
                    ClickableSettingItem(
                        title = stringResource(R.string.ai_scan_dict_config),
                        onClick = onNavigateToAiScanDict
                    )
                }
            }
