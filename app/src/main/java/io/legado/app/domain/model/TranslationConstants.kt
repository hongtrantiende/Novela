...
object TranslationConstants {
    ...
    val providerDisplayNames = listOf("Google Translate", "Giao diện thích ứng OpenAI", "Từ điển VietPhrase")
    val providerValues = listOf(PROVIDER_GOOGLE, PROVIDER_OPENAI, PROVIDER_VIETPHRASE)
