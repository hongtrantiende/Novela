...
object PreferKey {
    ...
    const val showUpdates = "showUpdates"
    ...
    const val SELECTED_COVER_ALBUM_ID = "selectedCoverAlbumId"
    const val SELECTED_LIGHT_COVER_ALBUM_ID = "selectedLightCoverAlbumId"
    const val SELECTED_DARK_COVER_ALBUM_ID = "selectedDarkCoverAlbumId"
    const val COVER_ALBUM_MIGRATED = "coverAlbumMigrated"
    // 中间单线间隔设置
    ...
    const val bgImageBookDetail = "backgroundImageBookDetail"
    const val bgImageBookDetailN = "backgroundImageBookDetailNight"
    const val enableBookInfoCoverTheme = "enableBookInfoCoverTheme"
    const val bookDetailHeaderStyle = "bookDetailHeaderStyle"
    const val bgImageBookDetailCard = "backgroundImageBookDetailCard"
    const val bgImageBookDetailCardN = "backgroundImageBookDetailCardNight"
